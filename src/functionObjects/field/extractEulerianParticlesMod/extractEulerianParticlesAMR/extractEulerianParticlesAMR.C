...
#include "extractEulerianParticlesAMR.H"
...
{
    defineTypeNameAndDebug(extractEulerianParticlesAMR, 0);
...
void Foam::functionObjects::extractEulerianParticlesAMR::createFiles()
{
...
void Foam::functionObjects::extractEulerianParticlesAMR::writeDataFileHeader
(
    Ostream& os
) const
{
...
void Foam::functionObjects::extractEulerianParticlesAMR::checkFaceZone()
{
    DebugInFunction << endl;
    
    if(!isA<dynamicRefineFvMeshMod>(mesh_))
    {
        FatalErrorInFunction
            << "Mesh is  not of type dynamicRefineFvMeshMod, functionObject extractEulerianParticlesAMR cannot be used"
            << exit(FatalError);
    }
...
void Foam::functionObjects::extractEulerianParticlesAMR::initialiseBins()
{
    DebugInFunction << endl;
...
Foam::functionObjects::extractEulerianParticlesAMR::phiU() const
{
    DebugInFunction << endl;
...
void Foam::functionObjects::extractEulerianParticlesAMR::setBlockedFaces
(
...
void Foam::functionObjects::extractEulerianParticlesAMR::collectParticles
(
    const scalar time,
...
void Foam::functionObjects::extractEulerianParticlesAMR::applyFaceZoneFaceMap
(
    const faceZone& fz,
...
{
    labelList faceMap = mesh_.dynamicRefineFvMeshModFaceMap();
...
void Foam::functionObjects::extractEulerianParticlesAMR::calculateAddressing
(
...
void Foam::functionObjects::extractEulerianParticlesAMR::accumulateParticleInfo
(
    const surfaceScalarField& alphaf,
    const surfaceScalarField& phi,
...
)
{
    ...
    forAll(regionFaceIDs, localFacei)
    {
        ...
        if (newRegioni != -1)
        {
            ...
            scalar Tfi = faceValue(Tf, localFacei, meshFacei);
            p.V += dV;
...
Foam::functionObjects::extractEulerianParticlesAMR::extractEulerianParticlesAMR
(
    const word& name,
    const Time& runTime,
...
:
    dynamicRefineFvMeshModFunctionObject(name, runTime, dict),
...
bool Foam::functionObjects::extractEulerianParticlesAMR::read
(
    const dictionary& dict
)
{
    ...
    if (dynamicRefineFvMeshModFunctionObject::read(dict) && writeFile::read(dict))
    {
...
bool Foam::functionObjects::extractEulerianParticlesAMR::execute()
{
    DebugInFunction << endl;
...
bool Foam::functionObjects::extractEulerianParticlesAMR::write()
{
    DebugInFunction << endl;
