...
#include "sinPerturbedCylinderImplicitFunction.H"
...
namespace Foam
{
    ...
    {
        defineTypeNameAndDebug(sinPerturbedCylinderImplicitFunction, 0);
...
Foam::implicitFunctions::sinPerturbedCylinderImplicitFunction::sinPerturbedCylinderImplicitFunction
(
    const point& origin,
    const scalar radius,
    const scalar scale,
...
:
    ...
    amplitude_(dict.getOrDefault<scalar>("amplitude", 0)),
    wavelength_(dict.getOrDefault<scalar>("wavelength", 0))
{}
