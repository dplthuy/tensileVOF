...
#include "tensileForceTwoPhaseMixtureThermo.H"
...
namespace Foam
{
    defineTypeNameAndDebug(tensileForceTwoPhaseMixtureThermo, 0);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::tensileForceTwoPhaseMixtureThermo::tensileForceTwoPhaseMixtureThermo
(
...
void Foam::tensileForceTwoPhaseMixtureThermo::correctThermo()
{
...
void Foam::tensileForceTwoPhaseMixtureThermo::correct()
{
...
Foam::word Foam::tensileForceTwoPhaseMixtureThermo::thermoName() const
{
    return thermo1_->thermoName() + ',' + thermo2_->thermoName();
}


bool Foam::tensileForceTwoPhaseMixtureThermo::incompressible() const
{
    return thermo1_->incompressible() && thermo2_->incompressible();
}


bool Foam::tensileForceTwoPhaseMixtureThermo::isochoric() const
{
    return thermo1_->isochoric() && thermo2_->isochoric();
}


Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::he
(
...
Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::he
(
    const scalarField& p,
    const scalarField& T,
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::hc() const
{
    return alpha1()*thermo1_->hc() + alpha2()*thermo2_->hc();
}


Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::THE
(
    const scalarField& h,
    const scalarField& p,
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::Cp() const
{
    return alpha1()*thermo1_->Cp() + alpha2()*thermo2_->Cp();
}


Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::Cp
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::Cv() const
{
    return alpha1()*thermo1_->Cv() + alpha2()*thermo2_->Cv();
}


Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::Cv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::gamma() const
{
    return alpha1()*thermo1_->gamma() + alpha2()*thermo2_->gamma();
}


Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::gamma
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::Cpv() const
{
    return alpha1()*thermo1_->Cpv() + alpha2()*thermo2_->Cpv();
}


Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::Cpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::CpByCpv() const
{
    return
...
Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::CpByCpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::W() const
{
    return alpha1()*thermo1_->W() + alpha2()*thermo1_->W();
}


Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::nu() const
{
    return mu()/(alpha1()*thermo1_->rho() + alpha2()*thermo2_->rho());
}


Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::nu
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::kappa() const
{
    return alpha1()*thermo1_->kappa() + alpha2()*thermo2_->kappa();
}


Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::kappa
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::alphahe() const
{
    return
...
Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::alphahe
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::kappaEff
(
...
Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::kappaEff
(
...
Foam::tmp<Foam::volScalarField> Foam::tensileForceTwoPhaseMixtureThermo::alphaEff
(
    const volScalarField& alphat
) const
{
...
Foam::tmp<Foam::scalarField> Foam::tensileForceTwoPhaseMixtureThermo::alphaEff
(
    const scalarField& alphat,
    const label patchi
) const
...
bool Foam::tensileForceTwoPhaseMixtureThermo::read()
{
    if (psiThermo::read())
    {
        return true;
