...
#include "compressibleTensileForceInterPhaseTransportModel.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::compressibleTensileForceInterPhaseTransportModel::compressibleTensileForceInterPhaseTransportModel
(
    ...
    const tensileForceTwoPhaseMixtureThermo& mixture
)
:
...
Foam::compressibleTensileForceInterPhaseTransportModel::alphaEff() const
{
    if (twoPhaseTransport_)
    {
        return
...
Foam::compressibleTensileForceInterPhaseTransportModel::divDevRhoReff
(
    volVectorField& U
) const
{
...
void Foam::compressibleTensileForceInterPhaseTransportModel::correctPhasePhi()
{
    if (twoPhaseTransport_)
    {
        const volScalarField& rho1 = mixture_.thermo1().rho();
...
void Foam::compressibleTensileForceInterPhaseTransportModel::correct()
{
    if (twoPhaseTransport_)
    {
